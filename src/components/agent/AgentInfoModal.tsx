...
const agentInfoData: Record<string, AgentInfo> = {
  ...
  "biz-support": {
    description: "Biz.Support Agent는 현업 사용자의 시스템 관련 문의를 지원하는 Agent입니다. 시스템 사용법, 오류 해결, 권한 문의 등 다양한 질문에 답변합니다.",
    features: [
      "시스템 사용법 안내",
      "오류 및 장애 1차 대응",
      "권한 및 계정 문의 처리",
    ...
    usageSteps: [
      ...
      "처리 Chat 이력에서 이전 문의 내용을 확인할 수 있습니다."
    ],
    tips: [
      "명확하고 구체적인 질문일수록 정확한 답변을 받을 수 있습니다.",
      "복잡한 문제는 ITS Agent로 요청을 등록하세요."
    ],
    relatedAgents: ["ITS Agent"]
  },
  infra: {

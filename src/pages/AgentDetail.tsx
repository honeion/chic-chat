      ...
      setTimeout(() => { 
        ...
        setChatSessions(prevSessions => {
          ...
          if (isReportGeneration && session) {
            ...
            // setGeneratedReports는 별도로 호출 (state batch 고려)
            setTimeout(() => setGeneratedReports(prev => [newReport, ...prev]), 0);

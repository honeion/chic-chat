...
const mockWorkflows = [
  { id: "1", name: "Health Check", next: "DB Connect" },
  { id: "2", name: "DB Connect", next: "Log Analyzer" },
  { id: "3", name: "Log Analyzer", next: "Alert Send" },
  { id: "4", name: "Alert Send", next: null },
];
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-chat-user/50 backdrop-blur-sm rounded-xl p-6 border border-border/50">
            ...
            <div className="space-y-2 text-sm">
              <div className="p-2 rounded-lg bg-secondary/50 hover:bg-secondary cursor-pointer transition-colors">
                장애 대응 매뉴얼
              </div>
              <div className="p-2 rounded-lg bg-secondary/50 hover:bg-secondary cursor-pointer transition-colors">
                배포 프로세스
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-2">
            {mockWorkflows.map((wf, index) => (
              <div key={wf.id} className="flex items-center">
                <div className="px-4 py-2.5 rounded-lg bg-chat-user/50 border border-border/50 text-sm whitespace-nowrap">
                  {wf.name}
                </div>
                {wf.next && (
            ...
            <div className="px-4 py-2.5 rounded-lg bg-secondary/50 text-sm text-muted-foreground">
              ...
            </div>
          </div>
        </div>
